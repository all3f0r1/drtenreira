...
export default function Home() {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    // Simuler l'envoi
    setTimeout(() => {
      const mailtoLink = `mailto:contact@drtenreira.be?subject=Demande de contact de ${contactForm.name}&body=Nom: ${contactForm.name}%0ATéléphone: ${contactForm.phone}%0AEmail: ${contactForm.email}%0A%0AMessage:%0A${contactForm.message}`;
              ...
              <div className="flex justify-center">
                <div className="relative w-full max-w-sm">
                  <img
                    ...
                    alt="Dr. Suzanne Tenreira Martins"
